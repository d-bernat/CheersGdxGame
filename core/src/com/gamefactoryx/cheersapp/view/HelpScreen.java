...
public class HelpScreen extends AbstractScreen {
    ...
    private com.gamefactoryx.cheersapp.model.HelpModel dataModel;
    ...
    public void show() {
        super.show();
        dataModel = com.gamefactoryx.cheersapp.model.HelpModel.getInstance();
    ...
    protected void initSprites() {
        setLandscapeSprite(new Sprite(new Texture(com.gamefactoryx.cheersapp.tool.Configuration.getLanguage() + "/help/help.png")));
        setPortraitSprite(new Sprite(new Texture(com.gamefactoryx.cheersapp.tool.Configuration.getLanguage() + "/help/help.png")));
        ...
        foreground = new Sprite(new Texture(com.gamefactoryx.cheersapp.tool.Configuration.getLanguage() + "/help/helpforg.png"));
    }
...
//            getTextBox().setSize(Resolution.getGameWorldWidthLandscape() * 0.92f, Resolution.getGameWorldHeightLandscape() * 0.85f);
        ...
        foreground.setSize(com.gamefactoryx.cheersapp.tool.Resolution.getGameWorldWidthPortrait(), com.gamefactoryx.cheersapp.tool.Resolution.getGameWorldHeightPortrait());
