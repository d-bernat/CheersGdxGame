...
public class Card {
    ...
    private String getFileName(int cardIndex, CardSize cardSize, CardOrientation orientation) {
        com.gamefactoryx.cheersapp.tool.CardType type;
        if (orientation == CardOrientation.BACK) {
            ...
            if (cardIndex >= 2 && cardIndex <= 14) {
                type = com.gamefactoryx.cheersapp.tool.CardType.HEART;
                prefix = "heart";
            } else if (cardIndex >= 15 && cardIndex <= 27) {
                type = com.gamefactoryx.cheersapp.tool.CardType.SPADE;
                prefix = "spades";
            } else if (cardIndex >= 28 && cardIndex <= 40) {
                type = com.gamefactoryx.cheersapp.tool.CardType.DIAMOND;
                prefix = "diamond";
            } else {
                type = com.gamefactoryx.cheersapp.tool.CardType.CLUB;
                prefix = "clubs";
            }
