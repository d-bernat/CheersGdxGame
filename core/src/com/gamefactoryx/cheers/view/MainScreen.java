...
public class MainScreen extends AbstractScreen {
    ...
    protected void initButtons() {
        ...
        switch (Configuration.getLanguage()) {
            case EN:
                getButtons()[4][0] = new Sprite(new Texture("common/button_clicked_de_lang.png"));
                getButtons()[4][1] = new Sprite(new Texture("common/button_clicked_de_lang.png"));
                break;
            case DE:
                getButtons()[4][0] = new Sprite(new Texture("common/button_clicked_eng_lang.png"));
                getButtons()[4][1] = new Sprite(new Texture("common/button_clicked_eng_lang.png"));
                break;
          //  case SK:
        ...
        getButtons()[5][0] = new Sprite(new Texture("common/Facebook_icon.png"));
        getButtons()[5][1] = new Sprite(new Texture("common/Facebook_icon.png"));
        getButtons()[6][0] = new Sprite(new Texture("common/Twitter_icon.png"));
        getButtons()[6][1] = new Sprite(new Texture("common/Twitter_icon.png"));
